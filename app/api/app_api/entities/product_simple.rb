module AppAPI
  module Entities
    class ProductSimple < Base
      ...
      expose :comments_count, documentation: {desc: '产品评论的数量', type: Float }
      expose :favorites_count, documentation: {desc: '产品收藏的数量', type: Float }
      expose :visits_count, documentation: {desc: '产品访问的数量', type: Float }
      expose :likes_count, documentation: {desc: '产品喜爱的数量', type: Float }
