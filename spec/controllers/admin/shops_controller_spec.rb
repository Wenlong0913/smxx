...
RSpec.describe Admin::ShopsController, type: :controller do
  ...
  # Admin::ShopsController. Be sure to keep this updated too.
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created admin_shop" do
        post :create, params: {shop: valid_attributes}
        expect(response).to redirect_to(admin_shop_url(Shop.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_shop" do
        shop = create(:shop)
        put :update, params: {id: shop.to_param, shop: new_attributes}
        shop.reload
        skip("Add assertions for updated state")
      end
      it "redirects to the admin_shop" do
        shop = create(:shop)
        put :update, params: {id: shop.to_param, shop: valid_attributes}
        expect(response).to redirect_to(admin_shop_url(shop))
      end
    end
    context "with invalid params" do
  ...
  describe "DELETE #destroy" do
    it "destroys the requested admin_shop" do
      shop = create(:shop)
      expect {
