...
RSpec.describe MaterialOutput, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id output_date note updated_at created_at))
  end
