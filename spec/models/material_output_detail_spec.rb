...
RSpec.describe MaterialOutputDetail, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id materila number updated_at created_at))
  end
  ...
  describe "Instance" do
    subject { build(:material_output_detail) }
