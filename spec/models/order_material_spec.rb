...
RSpec.describe OrderMaterial, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id order material amount updated_at created_at))
  end
