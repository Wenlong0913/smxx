...
RSpec.describe ShopSite, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id shop site updated_at created_at))
  end
