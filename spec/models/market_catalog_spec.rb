...
RSpec.describe MarketCatalog, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id name keywords description image_path updated_at created_at))
  end
