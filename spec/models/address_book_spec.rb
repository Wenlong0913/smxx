...
RSpec.describe AddressBook, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id user name gender mobile_phone city street house_number note updated_at created_at))
  end
