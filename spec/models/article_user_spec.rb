...
RSpec.describe ArticleUser, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id user article updated_at created_at))
  end
