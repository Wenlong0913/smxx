...
RSpec.describe ArticleProduct, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id article product updated_at created_at))
  end
