...
RSpec.describe FinanceBill, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id amount amount status updated_at created_at))
  end
