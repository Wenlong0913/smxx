...
RSpec.describe MemberCatalog, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id key value updated_at created_at))
  end
