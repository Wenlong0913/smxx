...
RSpec.describe Forage::Simple, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id run_key catalog title url features is_processed processed_at updated_at created_at))
  end
