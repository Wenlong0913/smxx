...
RSpec.describe Shop, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id user name description content contact_name contact_phone is_published note properties features impressions_count updated_at created_at))
  end
