...
RSpec.describe AccountHistory, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id account amount relation_account relation_type relation_date updated_at created_at))
  end
