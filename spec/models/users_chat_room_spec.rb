...
RSpec.describe UsersChatRoom, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id user chat_room last_message_id updated_at created_at))
  end
