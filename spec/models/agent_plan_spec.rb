...
RSpec.describe AgentPlan, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id name features updated_at created_at))
  end
