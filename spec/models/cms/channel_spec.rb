...
RSpec.describe Cms::Channel, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id site parent_id title short_title properties tmp_index tmp_detail keywords description image_path content updated_at created_at))
  end
