...
RSpec.describe MaterialManagementDetail, type: :model do
  ...
  it do
    expect(described_class.attribute_names).to match_array(%w(id material material_management number price price updated_at created_at))
  end
  ...
  describe "Instance" do
    subject { build(:material_management_detail) }
